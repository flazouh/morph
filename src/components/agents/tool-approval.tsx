...
// Morph adds: `approveLabel`, `alwaysAllowLabel`, `denyLabel`, `statusLabel` and `children`,
// so one permission card can speak about a browser switch and not only a tool run.
...
export interface ToolApprovalProps {
  ...
  /** Drawn under the description in every status: a hint, a fallback action. */
  children?: ReactNode;
  parameters?: ToolApprovalParameter[];
  status?: ToolApprovalStatus;
  /** Replaces the badge text for the current status. */
      ...
      <div className="flex items-start gap-3 p-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex min-w-0 items-start justify-between gap-3">
            ...
            <span
              data-testid="tool-approval-status"
              className={cn(
