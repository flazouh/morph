...
const optionDescriptionId = (
  ...
  `${prefix}-${optionIndex}-description`;
        ...
        question.multiple ? (
          <div className="grid gap-0.5">
            {question.options.map((option, optionIndex) => (
              <div key={option.value} className="rounded-lg hover:bg-background/45">
                <Checkbox
                  ...
                  aria-describedby={
                    option.description
                      ? optionDescriptionId(descriptionPrefix, optionIndex)
                      : undefined
                  }
                  ...
                  className="min-h-9 w-full rounded-lg px-1.5 py-1"
                />
                {option.description ? (
                  <p
                    id={optionDescriptionId(descriptionPrefix, optionIndex)}
                    className="-mt-1 pb-2 pl-10 pr-2 text-xs leading-4 text-muted-foreground"
                  >
                    {option.description}
                  </p>
                ) : null}
            ...
            {questionMode && question ? (
              <AnimatePresence initial={false} mode="wait">
                ...
                >
                  ...
                  {question.preview ? <div className="mt-3">{question.preview}</div> : null}
                  <QuestionOptions
                    question={question}
